...
wp core install --url=https://localhost:4343 --title=teste2 --admin_name=wwallas --admin_password=951 --admin_email=testando@gmail.com --allow-root --path=/var/www/html/wordpress
